...
print('\n')
print("                      Analise da Arvore de Decisao")
for x in range(5):
    test=[]
    train=[]
    # print(testing)
...
print("===========================================================")
print("===========================================================")
print('A media de precisao apos 5 Fold Cross Validation e: '+str(int(a/len(l)))+"%")
print("===========================================================")
print("===========================================================")
...
plt.xlabel('Folds')
plt.ylabel('Precisao')
plt.title('Precisao da Arvore de Decisao')
